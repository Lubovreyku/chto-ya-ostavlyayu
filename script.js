const cardsData = [
  { img: "images/card1.png", text: "Ты оставляешь бег.\nПришло время покоя." },
  { img: "images/card2.png", text: "Ты больше не обязана быть прежней.\nВсё, что отжило — можно оставить." },
  { img: "images/card3.png", text: "Страхи не идут с тобой дальше.\nСвет уже рядом.\nПозволь себе увидеть его." },
  { img: "images/card4.png", text: "Ты отпускаешь то, что ранило.\nСердце выбирает мягкость и покой." },
  { img: "images/card5.png", text: "Ты оставляешь вину.\nТы достаточно хороша уже сейчас." },
  { img: "images/card6.png", text: "Ты отпускаешь старые ожидания.\nЖизнь разворачивается мягко." },
  { img: "images/card7.png", text: "Ты оставляешь сомнения в себе.\nТвоя сила — с тобой." }
];
